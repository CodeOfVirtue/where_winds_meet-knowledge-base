...
This document lists all primary resources referenced in this repository.
These are the materials used for formulas, mechanics, maps, and build analysis.

Where applicable, notes are provided on:
- Language
- Accessibility
- Completeness
- Known limitations
...
### Community Damage Calculator (English)
- **Type:** Spreadsheet
- **Language:** English
- **Source:** Community translation / adaptation
- **Status:** Actively used
- **Notes:**  
  Contains damage calculator, hit-type breakdown, penetration notes, and attribute scaling.
  Layout is functional but combines multiple topics in one sheet.

### Original Damage Formula Spreadsheet (Chinese)
- **Type:** Spreadsheet
- **Language:** Chinese
- **Source:** CN community
- **Status:** Pending mirror (access restricted)
- **Notes:**  
  More detailed than the English version. Will be added once accessible.
...
### Bilibili – Damage Formula Breakdown
- **Type:** Video
- **Language:** Chinese
- **Platform:** Bilibili
- **Creator:** Yokalenlove
...
## Notes on Missing / Pending Sources

Some original CN materials require region-locked services (e.g. Kingsoft / WeChat).
These will be mirrored here once accessible, with full attribution.
